...
def get_arguments(args=None):
    ...
    parser.add_argument('--data_path', help='Where is data located?', type=str,
                        default='/truba/home/hbilgi/dev/thesis/mot_data')
    parser.add_argument('--output_path', help='Where is the output folder?', type=str,
                        default='/truba/home/hbilgi/dev/SUSHI/outputs')
    ...
    parser.add_argument('--load_transformers_only', action='store_true', default=False)
    
    # WEIGHT SHARING
    parser.add_argument('--share_weights', help='weight sharing scheme used', type=str, default='all')
    ...
    # parser.add_argument('--pruning_method_self', type=str, nargs='*', help='Pruning scheme used at each hierarchical level', default=['geometry', 'geometry', 'geometry', 'geometry', 'geometry', 'geometry', 'geometry'])
...
def ensure_config_consistency(config):
    ...
    """
    assert config.experiment_mode in ("train", "train-cval", "test", "eval", "val"), "Invalid experiment mode"
