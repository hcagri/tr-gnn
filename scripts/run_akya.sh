...
#SBATCH -J trainVal          # Gonderilen isin ismi
#SBATCH -o trainVal.out       # Ciktinin yazilacagi dosya adi
...
python main.py --experiment_mode train --cuda --train_splits ${SEQ_MAP1} --val_splits ${SEQ_MAP2} --run_id mot17_public_train \
    --save_cp --lr 0.001 --weight_decay 0.0001 --interpolate_motion --linear_center_only --det_file byte065 \
    ...
    --depth_pretrain_iteration 500 --num_epoch 200 --num_batch 4 --start_eval 60 --num_workers 4